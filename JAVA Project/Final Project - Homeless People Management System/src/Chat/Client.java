...
public class Client{  
    ...
    public Client() {  
        ...
        txt_hostIp = new JTextField("127.0.0.2");
        txt_hostIp = new JTextField("127.0.0.2");
        ...
        northPanel.setBorder(new TitledBorder("Connection Information"));  
        ...
        btn_start.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                int port;  
                if (isConnected) {  
                    JOptionPane.showMessageDialog(frame, "Already connected, Please do not connect again!",  
                ...
                try {  
                    try {  
                        ...
                        throw new Exception("Port number has to be an integer!");  
                    }  
                    String hostIp = txt_hostIp.getText().trim();  
                    String name = txt_name.getText().trim();  
                    if (name.equals("") || hostIp.equals("")) {  
                        throw new Exception("Name and IP of Server CANNOT be Blank!");  
                    }  
        ...
        btn_stop.addActionListener(new ActionListener() {  
            public void actionPerformed(ActionEvent e) {  
                if (!isConnected) {  
                    JOptionPane.showMessageDialog(frame, "Already in Off Status!",  
                            "错误", JOptionPane.ERROR_MESSAGE);  
                    return;  
                }  
                try {  
                    ...
                    if (flag == false) {  
                        throw new Exception("Offline Failed！");  
                    }  
                    JOptionPane.showMessageDialog(frame, "Successfully Off!");  
                } catch (Exception exc) {  
                    JOptionPane.showMessageDialog(frame, exc.getMessage(),  
                            "错误", JOptionPane.ERROR_MESSAGE);  
                }  
    ...
    public boolean connectServer(int port, String hostIp, String name) {  
        ...
        try {  
            ...
            textArea.append("Connect With：" + port + "    IP Address：" + hostIp  
                    + "   Failed!" + "\r\n");  
            ...
            while (true) {  
                try {  
                    ...
                    {  
                        ...
                        closeCon();// 被动的关闭连接  
                        JOptionPane.showMessageDialog(frame, "Server buffer is full！", "错误",  
                                JOptionPane.ERROR_MESSAGE);  
                        return;// 结束线程  
                    } else {// 普通消息  
