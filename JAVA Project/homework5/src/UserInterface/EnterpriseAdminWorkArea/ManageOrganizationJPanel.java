...
//    ManageOrganizationJPanel(JPanel userProcessContainer, Enterprise enterprise, OrganizationDirectory organizationDirectory) {
//        initComponents();
...
//    }
    ...
    private void populateCombo() {
        ...
        if (enterprise.getEnterpriseType().getValue().equals("CDC") ){
         ...
         if (enterprise.getEnterpriseType().getValue().equals("State Department Of Public Health")) {
            for (OrganizationType type : Organization.OrganizationType.values()) {
                if (!type.getValue().equals(OrganizationType.Admin.getValue())) {
                    if(!type.getValue().equals(OrganizationType.Distributor.getValue())){
                    organizationJComboBox.addItem(type);
